...
Every decision consumes attentional resources. Traditional productivity tools burden users with:
- Excessive options and configurations
...
- Symbolic rather than numeric information

### Gentle Guidance

Support focus through subtle visual cues rather than aggressive notifications or gamification.

Many focus tools rely on:
- Alarms and alerts that interrupt flow
- Gamification that turns work into competition
...
- Presence rather than performance metrics

### Attention Protection

Create boundaries that shield deep work from the constant pull of digital interruption and urgency.

Digital environments are designed to capture attention through:
- Notifications that demand immediate response
- Social signals that create urgency
...
Countdowns and minute-tracking create pressure that disrupts flow. Users watch the clock, become anxious about remaining time, and lose presence in their work.

### Metric Pressure

Streaks, scores, and tracking turn focus into performance. Users compete with themselves, optimize for metrics rather than immersion, and lose the practice of deep work.

### Digital Distraction

Interruptions scatter attention and increase fatigue. Every notification, option, and choice consumes cognitive resources and pulls focus away from meaningful work. Digital environments exploit our attentional limits.
...
- **Cognitive Science** – Decision fatigue, attentional limits, presence

### Translation to Practice

Research findings translate into design principles:

1. **Symbolic Time**  
Research: Time anxiety disrupts flow and reduces presence  
Practice: Visual metaphors replace numeric pressure

2. **Reduced Cognitive Load**  
Research: Decision fatigue exhausts attentional resources  
Practice: Minimal choices, gentle guidance, clear purpose

3. **Gentle Guidance**  
Research: Aggressive notifications fragment attention  
Practice: Subtle visual cues that support rather than interrupt

4. **Attention Protection**  
Research: Digital interruptions scatter focus and increase fatigue  
Practice: Boundaries that shield deep work from distraction
...
- **Visual chronoscape** provides gentle progress awareness
- **No metrics, streaks, or gamification** removes performance pressure
- **Offline operation** eliminates digital interruptions
- **Gentle completion** signals respect flow state
